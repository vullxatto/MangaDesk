          ...
          <div className="articles-content">
            ...
            <section className="article-block" id="translators">
              ...
              <p>
                ...
                глоссарий проекта <br />и вкладки (таблиицы) под каждую главу. В MangaDesk такая штука заполняется и обновляется автоматически
              ...
              <p>
                Шаг первый в работе над главой — собрать оригинальный текст в колонку «Оригинал». <br />Способов несколько.
              </p>
              <p>
              ...
              <p>
                ...
                распознавалку типа Яндекс.Переводчика. Удобный гибрид — программа NormCap: она совмещает скриншот
              ...
              <p>
                ...
                разом, а по несколько фраз), отправляете в нейронку с просьбой
