          ...
          <div className="articles-content">
            ...
            <section className="article-block" id="translators">
              ...
              <p>
                ...
                глоссарий проекта <br />и вкладки под каждую главу. В MangaDesk такая штука заполняется и обновляется автоматически
                при создании проекта, с возможностью ручных правок. Раньше мы использовали google-таблицы, поскольку они
                позволяют редактировать файл сразу нескольким людями.
              </p>
              <p>
                ...
                имена персонажей, названия мест, организаций, артефактов и техник,
                термины из мира произведения.
              </p>
              <p>
