    ...
    <aside className="articles-sidebar" aria-label="Навигация по статье">
      ...
      <nav className="articles-toc" aria-label="Разделы руководства">
        ...
        <div className="articles-toc-children">
          ...
          <a href="#translators-work-table" className={active === 'translators' && activeSubsection === 'translators-work-table' ? 'is-active' : ''}>Рабочая таблица</a>
        </div>
        ...
        <div className="articles-layout">
          ...
          <div className="articles-content">
            ...
            <section className="article-block" id="translators">
              ...
              <h4 className="article-block__subtitle" id="translators-work-table">Рабочая таблица</h4>
              <p>
                Любой перевод манги начинается не в фотошопе и не в голове, а в гугл-таблице. Это рабочий
                документ, в котором живёт оригинал, перевод, заметки и вся история проекта.
              </p>
              <p>
                В таблице обычно две основные сущности: глоссарий проекта и вкладки под каждую главу.
              </p>
              <h5 className="article-mini-card__title" style={{ marginTop: 'var(--space-4)' }}>Глоссарий</h5>
              <p>
                Это Ваша личная карта проекта. Сюда выписываем всё, что должно сохраняться от главы к главе:
                имена персонажей (на оригинале и в переводе), названия мест, организаций, артефактов и техник,
                термины из мира произведения, а также характерные особенности речи героев, если у кого-то есть
                запоминающаяся манера говорить.
              </p>
              <p>
                Если Вы переводите не с первой главы, а подхватываете проект, прочитайте уже выпущенные главы
                и заполните глоссарий до того, как сядете за свою. Это спасёт от ситуации, когда в новой главе
              ...
              <div className="article-mini-card" style={{ width: '100%', margin: '10px 0 16px' }}>
                <div style={{ overflowX: 'auto' }}>
                  <div
                    style={{
                      display: 'grid',
                      gridTemplateColumns: '1fr 1fr 0.7fr 1.2fr',
                      gap: '12px 16px',
                      fontSize: '14px',
                      color: 'var(--fg)',
                    }}
                  >
                    ...
                    <p style={{ margin: 0, fontWeight: 700, textTransform: 'uppercase', color: 'rgba(var(--fg-rgb), 1)' }}>Тип</p>
                    ...
                    <p style={{ margin: 0 }}>термин</p>
                    <p style={{ margin: 0 }}>артефакт героя</p>
                    <p style={{ margin: 0 }}>桜高校</p>
                    <p style={{ margin: 0 }}>старшая школа «Сакура»</p>
                    <p style={{ margin: 0 }}>локация</p>
                    <p style={{ margin: 0 }}>школа главной героини</p>
                    <p style={{ margin: 0 }}>…говорит с паузами, обрывает фразы</p>
                    <p style={{ margin: 0 }}>…</p>
                    <p style={{ margin: 0 }}>речь</p>
                    <p style={{ margin: 0 }}>характерная манера персонажа</p>
                  </div>
                </div>
              </div>
              <h5 className="article-mini-card__title" style={{ marginTop: 'var(--space-4)' }}>Вкладка главы</h5>
              <p>
                Под каждую главу — отдельная вкладка с двумя основными колонками: Оригинал (текст из облачков
                на исходном языке) и Перевод (Ваша русская версия). Иногда добавляют ещё колонку для комментариев
                и для номера страницы — на свой вкус.
              </p>
              <div className="article-mini-card" style={{ width: '100%', margin: '10px 0 16px' }}>
                <div style={{ overflowX: 'auto' }}>
                  <div
                  ...
                  >
                    ...
                    <p style={{ margin: 0 }}>Wait, where are you going?!</p>
                    <p style={{ margin: 0 }}>СТОЙ, КУДА ТЫ?!</p>
                  </div>
                </div>
              </div>
              <h5 className="article-mini-card__title" style={{ marginTop: 'var(--space-4)' }}>Как вытащить текст со сканов</h5>
              <p>
                Шаг первый в работе над главой — собрать оригинальный текст в колонку «Оригинал». Способов несколько.
              </p>
              <p>
                Самый надёжный — вручную. Если Вы знаете язык оригинала, просто перепечатываете текст из облачков.
              ...
              <p>
                Самый быстрый — через MangaDesk. Загружаете ZIP с исходниками, сервис распознаёт текст и раскладывает
                его по облачкам в таблице. Дальше Вам остаётся проверить результат и переходить к переводу. Так как
                сервис заточен именно под мангу, с ним меньше шансов получить кашу в местах, где стандартные
                распознавалки спотыкаются.
              </p>
              <p>
                Если хочется собрать всё руками из внешних инструментов — пожалуйста, вариантов хватает. Делаете
                скриншот фрагмента (Win + Shift + S на Windows, Cmd + Shift + 4 на macOS) и кидаете его в
                распознавалку. Из бесплатных лучше всего справляется Яндекс.Переводчик — у него самый адекватный OCR
                для японского, китайского и корейского. Удобный гибрид — программа NormCap: она совмещает скриншот
                и распознавание в один шаг, скачивается в варианте «Installer». С декоративными или нестандартными
                шрифтами справляется плохо, но для типового текста — отличная штука. Также можно отправлять скрины
                в Claude, Gemini, DeepSeek или ChatGPT — они хорошо распознают текст, особенно с японского и китайского.
              </p>
              <div className="article-mini-card" style={{ margin: '12px 0 18px', textAlign: 'center' }}>
                <p className="article-muted" style={{ margin: 0 }}>
                  [Коллаж иконок: Яндекс.Переводчик, NormCap, Claude, Gemini, DeepSeek]
                </p>
                <p style={{ textAlign: 'center', color: 'var(--fg)', fontSize: '14px', marginTop: '8px' }}>
                  выбирайте на вкус и привычку
                </p>
              </div>
              <p>
                Что бы Вы ни использовали — всегда проверяйте результат. Распознавалки обожают путать похожие
                иероглифы, имена и термины искажают чаще всего. Один пропущенный символ в имени — и весь перевод
                поедет.
              </p>
              ...
              <p>
                Вручную через сторонние сервисы тоже можно. Копируете содержимое «Оригинала» по частям (не весь столбец
                разом — так точнее держится контекст), отправляете в Claude, Gemini, DeepSeek или ChatGPT с просьбой
                перевести на русский. Полученный перевод можно прогнать через второй сервис для проверки, а потом —
                корректировать под правила, которые мы разобрали выше: чтобы звучало живо, естественно и по-русски.
              </p>
              <p>
                Помните одну вещь: что бы Вам ни выдал любой инструмент, это черновик, а не готовый перевод. Финальная
                редактура всегда на Вас. Программа не чувствует ни иронии, ни характера персонажа, ни того, что в этой
                сцене персонаж шутит, а в этой — врёт. Это всё ещё работа человека.
              </p>
              <div className="article-mini-card" style={{ margin: '12px 0 18px', textAlign: 'center' }}>
                <p className="article-muted" style={{ margin: 0 }}>
                  [Шутка-картинка: переводчик смотрит на сырой машинный перевод — «спасибо, дальше я сам»]
                </p>
              </div>
              <h5 className="article-mini-card__title" style={{ marginTop: 'var(--space-4)' }}>Как происходит передача готовой главы</h5>
              <p>
                Внутренние процессы команд устроены по-разному, и единого стандарта нет. Где-то всё происходит в
                Telegram, где-то в Discord, где-то в Notion, где-то в гугл-доках и переписках. Общая логика обычно
                такая: переводчик получает ссылку на исходник и рабочую таблицу, дату дедлайна и пометки об особенностях
                проекта (например, «звуки переводим, клиним, тайпим» или «используем такой-то шрифт»). Иногда
                оригиналы приходят отдельным ZIP с PNG и PSD — на случай если сайт-источник упадёт. Дальше переводчик
                заполняет таблицу и сообщает о готовности тому, кто координирует работу.
              </p>
              <p>
                Если вся команда работает в MangaDesk, эти шаги собраны в одном месте: проект, дедлайн, статус задачи,
                переписка, файлы. Перевод уходит к клинеру и тайперу автоматически, как только Вы отметите главу
                готовой, — и не надо договариваться, кто кому какой архив пересылает.
              </p>
              <p>
                Поздравляем, глава готова к передаче. Дальше за неё возьмётся клинер. Про то, что он там делает — в
                следующем разделе.
              </p>
            </section>
