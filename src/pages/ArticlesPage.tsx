          ...
          <div className="articles-content">
            ...
            <section className="article-block" id="cleaners">
              ...
              <p>
                ...
                текст, восстановить фон под ним и убрать артефакты. Задача не простая, так что
                давайте разберём, как делать не надо, и как делать по уму.
              </p>
              <img
                src={meme4Avif}
                alt="Meme"
            ...
            <section className="article-block" id="typers">
              ...
              <p>
                ...
                перевод и чистый «холст» после переводчика и клинера, чтобы собрать <br />из них финальную страницу: расставить реплики по облачкам,
              ...
              />
              <h4 className="article-block__subtitle" id="typers-bubble-layout">Размещение текста</h4>
              <p>
              ...
              <p>
                ...
                При этом не нужно бояться, что форма текста <br/>получится слишком «сложной»: если реплика длинная, облачко это
                компенсирует.
              </p>
              ...
              <p>
                Тайп не должен содержать шрифтов Arial, Times New Roman, Comic Sans и подобные. Эти шрифты мгновенно
                удешевляют картинку и кричат «тут тайпил новичок».  
                </p>
                <p>  
                Кроме того, шрифты должны быть свободны
                от авторских прав, то есть распространяться по лицензии OFL (Open Font License). Брать бесплатные шрифты можно на{' '}
